...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Bamboo Calendar is a cross-platform web app for managing family schedules and tasks with a calming, nature-inspired theme." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Bamboo Calendar is a cross-platform web app for managing family schedules and tasks with a calming, nature-inspired theme." },
