...
async function handleCreatedOrUpdated(subscription: any, env: StripeEnv, isNew: boolean) {
...
async function handleWebhook(req: Request, env: StripeEnv) {
  ...
  switch (event.type) {
    case "customer.subscription.created":
      await handleCreatedOrUpdated(event.data.object, env, true);
      break;
    case "customer.subscription.updated":
      await handleCreatedOrUpdated(event.data.object, env, false);
      break;
