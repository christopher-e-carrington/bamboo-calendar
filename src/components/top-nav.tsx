    ...
    <header className="sticky top-0 z-30 backdrop-blur-md bg-background/70 border-b border-border">
      <div className="flex items-center gap-2 px-3 sm:px-5 h-14">
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          <Button variant="ghost" size="icon" className="inline-flex" onClick={() => onNavigate("today")} aria-label="Today">
            <Home className="h-4 w-4" />
          </Button>
          <Button variant="ghost" size="icon" className="inline-flex" onClick={() => onNavigate("calendar")} aria-label="Calendar">
